...
class TestBuscandodressenlabarradebusquedas():
  ...
  def test_buscandodressenlabarradebusquedas(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "table:nth-child(2)").click()
    self.driver.find_element(By.CSS_SELECTOR, "table:nth-child(2)").click()
